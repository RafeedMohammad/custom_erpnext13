...
class override_LoanRepayment(AccountsController):
	def validate(self):
...
def get_amounts(amounts, against_loan, posting_date):
	...
	amounts["loan_opening_amount"] = flt(against_loan_doc.loan_opening_amount, precision)
