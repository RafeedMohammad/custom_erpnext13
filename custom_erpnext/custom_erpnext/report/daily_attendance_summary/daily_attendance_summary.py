...
def get_columns():
	return [
		...
		_("Shift Day") + ":Data/:120",
		_("Shift Night") + ":Data/:120",
		_("Today's Present Manpower") + ":Data/:120",
		_("Today's Present Manpower Parcentage") + ":Data/:120",
		_("Absent Manpower") + ":Data/:120",
		_("Absent Manpower Parcentage") + ":Data/:120",
		_("Leave Manpower") + ":Data/:120",
		_("Leave Manpower Parcentage") + ":Data/:120",
		_("Discontinue/Resign") + ":Data/:120",
		 _("OT") + ":Data/:120",
		#_("Remarks") + ":Data/:120",
...
def get_data(filters):
	...
	SUM(CASE WHEN att.status in ('Absent') THEN 1 ELSE 0 END),
