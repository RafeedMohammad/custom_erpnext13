			...
			self.get_gl_dict(
				{
					...
					"debit": self.loan_opening_amount,
					"debit_in_account_currency": self.loan_opening_amount,
					"against_voucher_type": "Loan",
					"against_voucher": self.name,
					"remarks": _("Repayment against loan ")+ self.name,
			...
			self.get_gl_dict(
				{
					...
					"credit": self.loan_opening_amount,
					"credit_in_account_currency": self.loan_opening_amount,
					"against_voucher_type": "Loan",
					"against_voucher": self.name,
					"remarks": _("Repayment against loan ")+ self.name,
					"cost_center": self.cost_center,
