...
class PayrollEntry(Document):
	...
	def create_salary_slips(self):
		...
		if employees:
			...
			if len(employees) > 30:
				frappe.enqueue(create_salary_slips_for_employees, timeout=1600, employees=employees, args=args)
			else:
	...
	def submit_salary_slips(self):
		...
		if len(ss_list) > 30:
			frappe.enqueue(
				submit_salary_slips_for_employees, timeout=1600, payroll_entry=self, salary_slips=ss_list
			)
		else:
